...
/* C:\xampp\htdocs\laravel/ambiente_conversao/vestibularfam2020.1/views//bem-vindo.twig */
class __TwigTemplate_88a7e28582beaa67c2db96e8caca2e15fc005338a49a1e851264bdc8a2c9af72 extends TwigBridge\Twig\Template
{
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\laravel/ambiente_conversao/vestibularfam2020.1/views//bem-vindo.twig";
    }
    ...
    {
        return array (  447 => 363,  419 => 338,  354 => 275,  350 => 273,  344 => 272,  339 => 270,  335 => 268,  324 => 264,  319 => 262,  315 => 260,  313 => 259,  310 => 258,  307 => 257,  301 => 255,  299 => 254,  294 => 253,  292 => 252,  288 => 251,  239 => 207,  223 => 196,  188 => 164,  26 => 4,  24 => 3,  21 => 2,  19 => 1,);
    }
...
<body width=\"100%\" bgcolor=\"#0b2f7f\" style=\"Margin: 0;\">
    <center style=\"width: 100%; background: #092668;\">
        ...
        <!-- Visually Hidden Preheader Text : BEGIN -->
        <div style=\"display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;\">
            Seja bem-vind{{ aluno.genero_letra }} à FAM! Confira os dados da sua inscrição!
        </div>
        <!-- Visually Hidden Preheader Text : END -->
...
\t            </tr>
            ...
            <table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\" bgcolor=\"#ffffff\" width=\"100%\" style=\"max-width: 680px;\">
                ...
                <!--<tr>
\t\t\t\t\t<td>
\t\t\t\t\t\t<img src=\"https://vestibularfam.com.br/assets/imagens_email/cabecalho.jpg?utc={{ utc }}\" width=\"680\" height=\"\" alt=\"Seja bem-vind{{ aluno.genero_letra }} à FAM!\" border=\"0\" align=\"center\" style=\"width: 100%; max-width: 680px;\">
\t\t\t\t\t</td>
                </tr>-->
                <!-- Hero Image, Flush : END -->
...
\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t<td style=\"padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;\">
                                    <strong style=\"font-size: 1.4em; display:block; color: #111111;\">Seja bem-vind{{ aluno.genero_letra }}, {{ aluno.primeiro_nome }}!!</strong>
\t\t\t\t\t\t\t\t\tSeu pedido de inscrição foi realizado com sucesso.<br />
                                    Esperamos por você no centro de uma poderosa estrutura de ensino.
\t\t\t\t\t\t\t\t\t<br><br>
\t\t\t\t\t\t\t\t\t<!-- Button : Begin -->
...
\t\t\t\t\t\t\t</tr>
                            ...
                            <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\" width=\"100%\" style=\"max-width:500px; Margin: auto;\">
                                <tr>
                                    <td valign=\"middle\" style=\"text-align: center; padding: 40px 20px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #ffffff;\">
                                        ...
                                        <p>
                                            <strong>Opções de Curso:</strong><br />
                                            Primeira opção: {{ opcoes_curso[0].nome }}
                                            {% if opcoes_curso[1] %}
                                                <br />Segunda opção: {{ opcoes_curso[1].nome }}
                                                {% if opcoes_curso[2] %}
                                                    <br />Terceira opção: {{ opcoes_curso[2].nome }}
                                                {% endif %}
                                            {% endif %}
                                        </p>
                                    {% if usarenem == 'sim' %}
                                        <p>
                                            <strong>Data entrega da documentação:</strong><br />
                                            {{ prova.data.hora()|date('d/m/Y') }}<br />
                                            <strong>Horário</strong><br />
                                            {% if periodo_manha %}das 08:30 às 11:30{% else %}das 9:00 às 21:00{% endif %}<br />
                                            <strong>Não se esqueça de trazer sua nota do ENEM válida!</strong>
                                        </p>
                                    {% else %}
                                        <p>
                        ...
                        <table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"100%\">
                            ...
                            <tr>
                                <td style=\"padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;\">
                                    ...
                                    <strong>Veja como chegar:</strong>
                                    <a href=\"https://goo.gl/maps/tBKjGzKqmAA2\" target=\"_blank\">
                                        <img src=\"http://{{ modulo.url }}/assets/imagens_email/mapa-fam.png\" width=\"100%\" border=\"0\" />
                                    </a>
                                    <br><br>
                                    <!-- Button : Begin -->
                                    <table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\" style=\"Margin: auto\">
                ...
                <!--<tr>
                    <td>
                        <img src=\"http://{{ modulo.url }}/assets/imagens_email/rodape.png?utc={{ utc }}\" width=\"680\" height=\"\" alt=\"\" border=\"0\" align=\"center\" style=\"width: 100%; max-width: 680px;\">
                    </td>
                </tr>-->
                <!-- Hero Image, Flush : END -->
\t\t\t</table>
...
{% endspaceless %}", "C:\\xampp\\htdocs\\laravel/ambiente_conversao/vestibularfam2020.1/views//bem-vindo.twig", "");
    }
}
