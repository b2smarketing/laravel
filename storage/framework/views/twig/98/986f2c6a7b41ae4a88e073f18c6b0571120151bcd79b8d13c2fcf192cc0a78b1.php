...
/* C:\xampp\htdocs\laravel\app\Modules\Admin\views/FaculdadeAberta/index.twig */
class __TwigTemplate_bfe9e7c547ba1fa1499e297ceb999210c8d3564d1b628cfc35f94ac73d0bf422 extends TwigBridge\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("Admin::layout", "C:\\xampp\\htdocs\\laravel\\app\\Modules\\Admin\\views/FaculdadeAberta/index.twig", 1);
        $this->blocks = array(
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\laravel\\app\\Modules\\Admin\\views/FaculdadeAberta/index.twig";
    }
...
{% set title = 'Faculdade Aberta 2019' %}
{% set opcoes =
[
          ...
          <div class=\"col-md-12 col-sm-12 col-xs-12\">
            ...
            <div class=\"col-md-12 col-sm-12 col-xs-12 mt-3\">
                <div class=\"x_panel\">
                    ...
                    <div class=\"x_content\">
                        {% for opcao in opcoes %}
                            <a href=\"/faculdadeaberta/data-periodo/{{ opcao.id }}\">
                            <p class=\"x_option\"><b>{{ opcao.data }}</b> - {{ opcao.horario }} ({{ opcao.id }})</p>
                            </a>
                            {% if not loop.index %}
                            <hr/>
                            {% endif %}
...
{% endblock %}", "C:\\xampp\\htdocs\\laravel\\app\\Modules\\Admin\\views/FaculdadeAberta/index.twig", "");
    }
}
