...
/* C:\xampp\htdocs\laravel\resources\views/error-code.twig */
class __TwigTemplate_1d678efb28b6a950bf54c92936dcd808bee998f4f28552c4851063f8e994c7ae extends TwigBridge\Twig\Template
{
...
<main>
\t<div id=\"logo\">
\t\t<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" preserveAspectRatio=\"xMidYMid\" width=\"181\" height=\"72\" viewBox=\"0 0 181 72\">
\t\t  <defs>
\t\t    <style>
\t\t      .cls-1 {
\t\t        fill: #fff;
...
\t\t</svg>
\t</div>
\t<h1>Ocorreu um erro ao processar sua ação</h1>
\t<p>
\t\tNossa equipe técnica já foi notificada do erro e estaremos investigando.<br />
...
";
        // line 75
        if ((($context["exception"] ?? null) && $this->getAttribute(($context["exception"] ?? null), "getMessage", array(), "method"))) {
            // line 76
            echo "\t<h2>Detalhes do erro:</h2>
\t<code>";
            // line 77
            echo twig_escape_filter($this->env, $this->getAttribute(($context["exception"] ?? null), "getMessage", array(), "method"), "html", null, true);
            echo "</code>
";
        }
        // line 79
...
<link href=\"https://fonts.googleapis.com/css?family=Fira+Sans:300,500\" rel=\"stylesheet\">
    ...
    {
        return "C:\\xampp\\htdocs\\laravel\\resources\\views/error-code.twig";
    }
    ...
    {
        return array (  108 => 79,  103 => 77,  100 => 76,  98 => 75,  94 => 74,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("", "C:\\xampp\\htdocs\\laravel\\resources\\views/error-code.twig", "");
    }
}
