...
/* C:\xampp\htdocs\vestibularfam\app\Modules\Admin\views/Unidades/index.twig */
class __TwigTemplate_3407cb3da75c379f0c638bcb294b018c174f7970cb57bd45a491c82c64f255f3 extends TwigBridge\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("Admin::layout", "C:\\xampp\\htdocs\\vestibularfam\\app\\Modules\\Admin\\views/Unidades/index.twig", 1);
        $this->blocks = array(
    ...
    {
        // line 3
        $context["form"] = $this->loadTemplate("Admin::helpers.form_modulo", "C:\\xampp\\htdocs\\vestibularfam\\app\\Modules\\Admin\\views/Unidades/index.twig", 3);
        // line 5
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\vestibularfam\\app\\Modules\\Admin\\views/Unidades/index.twig";
    }
                ...
                <div class=\"x_content\">
                  ...
                  {% for unidade in unidades %}
                      <tr>
                        ...
                        <td>{{ unidade.nome }}</td>
                        <td>
                          <a href=\"https://www.google.com.br/maps/@{{ unidade.coordenadas.latitude }},{{ unidade.coordenadas.longitude }},{{ unidade.coordenadas.zoom }}z?q=loc:{{ unidade.coordenadas.latitude }},{{ unidade.coordenadas.longitude }}&hl=pt-BR\" target=\"_blank\">
                          {{ unidade.endereco_completo }}
                          </a>
                        </td>
                        <td><a href=\"tel:+55{{ unidade.telefone }}\">{{ unidade.telefone }}</a></td>
                        <td><a href=\"mailto:{{ unidade.email }}\">{{ unidade.email }}</a></td>
                        <td>
...
{% endblock %}", "C:\\xampp\\htdocs\\vestibularfam\\app\\Modules\\Admin\\views/Unidades/index.twig", "");
    }
}
